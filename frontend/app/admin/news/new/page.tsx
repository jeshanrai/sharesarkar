        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <textarea
              ...
              rows={15}
              className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#009429]/20 focus:border-[#009429] resize-y font-mono"
            />
            <p className="text-xs text-gray-400 mt-2">Separate paragraphs with blank lines.</p>
          </div>

          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              <ImageIcon className="w-4 h-4 inline mr-1" /> Featured Image URL
            </label>
            <input
              type="url"
