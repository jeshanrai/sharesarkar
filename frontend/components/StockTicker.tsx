...
export default function StockTicker() {
  ...
  if (stocks.length === 0) {
    return (
      <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white py-2 border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 lg:px-8 flex items-center gap-3 text-xs text-white/50">
  ...
  return (
    <div className="bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-white py-2 overflow-hidden border-b border-white/5">
      <div className="flex items-center">
        {/* Live label */}
        <div className="hidden sm:flex shrink-0 items-center gap-2 px-4 border-r border-white/10 mr-2">
          <span className="relative flex h-1.5 w-1.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75" />
            <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-emerald-500" />
          </span>
