...
export default function StockTicker() {
  ...
  if (stocks.length === 0) {
    return (
      <div className="bg-slate-50 border-b border-slate-200 py-2">
        <div className="mx-auto max-w-7xl px-4 lg:px-8 flex items-center gap-3 text-xs text-slate-400">
  ...
  return (
    <div className="bg-slate-50 border-b border-slate-200 py-2 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 lg:px-8 flex items-center">
        {/* Live label */}
        <div className="hidden sm:flex shrink-0 items-center gap-2 pr-4 border-r border-slate-200 mr-2">
          <span className="relative flex h-1.5 w-1.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75" />
            <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-emerald-500" />
          </span>
